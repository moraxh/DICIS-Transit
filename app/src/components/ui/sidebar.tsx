...
function SidebarProvider({
  ...
  const toggleSidebar = React.useCallback(() => {
    return isMobile ? setOpen(true) : setOpen((open) => !open);
  }, [isMobile, setOpen]);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative hidden bg-transparent transition-[width] duration-200 ease-linear md:block md:w-(--sidebar-width)",
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-0 z-10 flex h-svh w-screen max-w-full transition-[left,right,width] duration-200 ease-linear md:inset-y-0 md:w-(--sidebar-width) md:data-[side=left]:left-0 md:data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] md:data-[side=right]:right-0 md:data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]",
