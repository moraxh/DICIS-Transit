...
const actions = [
  {
    ...
    icon: Megaphone,
    color: "text-orange-400 bg-orange-500/10 border-orange-500/15 hover:bg-orange-500/15",
  },
  {
    key: "routes" as const,
    label: "Editar rutas",
    ...
    icon: Map,
    color: "text-blue-400 bg-blue-500/10 border-blue-500/15 hover:bg-blue-500/15",
  },
];

export function QuickActions({ onNewNotice, onManageRoutes }: QuickActionsProps) {
